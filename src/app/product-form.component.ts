...
import { Product, CreateProductPayload } from '../products.model';
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
          ...
          <div class="mb-4">
            ...
            @if (form.get('price')?.invalid && form.get('price')?.touched) {
              <p class="text-red-500 text-sm mt-1">Valid price is required</p>
            }
          </div>
          ...
          <div class="mb-4">
            ...
            @if (form.get('stock')?.invalid && form.get('stock')?.touched) {
              <p class="text-red-500 text-sm mt-1">Valid stock is required</p>
            }
          </div>
          ...
          <div class="mb-6">
            ...
            @if (form.get('image')?.invalid && form.get('image')?.touched) {
              <p class="text-red-500 text-sm mt-1">Valid image URL is required</p>
            }
          </div>
